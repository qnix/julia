...
stagedfunction _unsafe_getindex{T,N}(l::LinearIndexing, A::AbstractArray{T,N}, I::Union(Real,AbstractArray,Colon,CartesianIndex)...)
    idxs = cartindex_exprs(I, :I)
    if (l <: LinearSlow && length(idxs) == N) || (l <: LinearFast && length(idxs) == 1)
...
stagedfunction _setindex!{T,N}(l::LinearIndexing, A::AbstractArray{T,N}, v, I::Union(Real,AbstractArray,Colon,CartesianIndex)...)
    idxs = cartindex_exprs(I, :I)
    if (l <: LinearSlow && length(idxs) == N) || (l <: LinearFast && length(idxs) == 1)
...
stagedfunction _unsafe_setindex!{T,N}(l::LinearIndexing, A::AbstractArray{T,N}, v, I::Union(Real,AbstractArray,Colon,CartesianIndex)...)
    idxs = cartindex_exprs(I, :I)
    if (l <: LinearSlow && length(idxs) == N) || (l <: LinearFast && length(idxs) == 1)
